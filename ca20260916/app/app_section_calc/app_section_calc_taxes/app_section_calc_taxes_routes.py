"""
app_section_calc_taxes_routes.py
---------------------------------
...
from app.app_section_calc.app_section_calc_taxes import (
    app_section_calc_taxes_logic_nds as logic_nds,
    app_section_calc_taxes_logic_ndfl as logic_ndfl
)
...
_tpl_dir = Path(__file__).parent / "app_section_calc_taxes_tpl"
...
async def taxes_hub_page(request: Request):
    ...
    return templates.TemplateResponse(
        request=request,
        name="app_section_calc_taxes_tpl_hub.html",
...
async def nds_calculator_page(request: Request):
    ...
    return templates.TemplateResponse(
        request=request,
        name="app_section_calc_taxes_tpl_nds.html",
        context={
            "result": None,
            "input_action": "add",
            "input_amount": "",
...
async def ndfl_calculator_page(request: Request):
    ...
    return templates.TemplateResponse(
        request=request,
        name="app_section_calc_taxes_tpl_ndfl.html",
        context={
            "result": None,
            "input_income": "",
            "input_deductions": 0,
