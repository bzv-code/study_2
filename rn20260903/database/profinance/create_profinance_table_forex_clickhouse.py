...
def create_table() -> None:
    """
    Создать таблицу ProFinance в ClickHouse.
...
def main() -> None:
    ...
    logger.info("=" * 70)
    logger.info("PROFINANCE FOREX CLICKHOUSE TABLE CREATION")
    logger.info("=" * 70)
    ...
    try:
        ...
        logger.exception(
            "CLICKHOUSE: failed to create ProFinance table"
        )
        raise

    logger.info("=" * 70)
    logger.info("PROFINANCE FOREX CLICKHOUSE TABLE CREATION FINISHED")
    logger.info("=" * 70)
