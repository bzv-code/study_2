...
def create_table() -> None:
    """
    Создать таблицу ProFinance Fond в ClickHouse.
...
def main() -> None:
    ...
    logger.info("=" * 70)
    logger.info("PROFINANCE FOND CLICKHOUSE TABLE CREATION")
    logger.info("=" * 70)
    ...
    try:
        ...
        logger.exception(
            "CLICKHOUSE: failed to create ProFinance Fond table"
        )
        raise

    logger.info("=" * 70)
    logger.info("PROFINANCE FOND CLICKHOUSE TABLE CREATION FINISHED")
    logger.info("=" * 70)
