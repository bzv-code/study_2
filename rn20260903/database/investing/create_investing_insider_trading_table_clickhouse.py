...
def main() -> None:
    logger.info("=" * 70)
    logger.info("INVESTING INSIDER TRADING CLICKHOUSE TABLE CREATION")
    logger.info("=" * 70)
    ...
    try:
        ...
        logger.exception("CLICKHOUSE: failed to create Investing Insider Trading table")
        raise

    logger.info("=" * 70)
    logger.info("INVESTING INSIDER TRADING CLICKHOUSE TABLE CREATION FINISHED")
    logger.info("=" * 70)
