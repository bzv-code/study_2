...
def main() -> None:
    logger.info("=" * 70)
    logger.info("INVESTING INVESTMENT IDEAS CLICKHOUSE TABLE CREATION")
    logger.info("=" * 70)
    ...
    try:
        ...
        logger.exception("CLICKHOUSE: failed to create Investing Investment Ideas table")
        raise

    logger.info("=" * 70)
    logger.info("INVESTING INVESTMENT IDEAS CLICKHOUSE TABLE CREATION FINISHED")
    logger.info("=" * 70)
