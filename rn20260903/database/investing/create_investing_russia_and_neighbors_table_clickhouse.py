...
def main() -> None:
    logger.info("=" * 70)
    logger.info("INVESTING RUSSIA AND NEIGHBORS CLICKHOUSE TABLE CREATION")
    logger.info("=" * 70)
    ...
    try:
        ...
        logger.exception("CLICKHOUSE: failed to create Investing Russia and Neighbors table")
        raise

    logger.info("=" * 70)
    logger.info("INVESTING RUSSIA AND NEIGHBORS CLICKHOUSE TABLE CREATION FINISHED")
    logger.info("=" * 70)
