...
def main() -> None:
    logger.info("=" * 70)
    logger.info("INVESTING STOCK CLICKHOUSE TABLE CREATION")
    logger.info("=" * 70)
    ...
    try:
        ...
        logger.exception("CLICKHOUSE: failed to create Investing Stock table")
        raise

    logger.info("=" * 70)
    logger.info("INVESTING STOCK CLICKHOUSE TABLE CREATION FINISHED")
    logger.info("=" * 70)
