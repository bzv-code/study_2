...
def main() -> None:
    logger.info("=" * 70)
    logger.info("INVESTING ECONOM CLICKHOUSE TABLE CREATION")
    logger.info("=" * 70)
    ...
    try:
        ...
        logger.exception("CLICKHOUSE: failed to create Investing Econom table")
        raise

    logger.info("=" * 70)
    logger.info("INVESTING ECONOM CLICKHOUSE TABLE CREATION FINISHED")
    logger.info("=" * 70)
