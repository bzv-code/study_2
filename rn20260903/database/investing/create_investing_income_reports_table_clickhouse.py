...
def main() -> None:
    logger.info("=" * 70)
    logger.info("INVESTING INCOME REPORTS CLICKHOUSE TABLE CREATION")
    logger.info("=" * 70)
    ...
    try:
        ...
        logger.exception("CLICKHOUSE: failed to create Investing Income Reports table")
        raise

    logger.info("=" * 70)
    logger.info("INVESTING INCOME REPORTS CLICKHOUSE TABLE CREATION FINISHED")
    logger.info("=" * 70)
