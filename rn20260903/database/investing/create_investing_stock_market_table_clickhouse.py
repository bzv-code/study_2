...
def main() -> None:
    logger.info("=" * 70)
    logger.info("INVESTING STOCK MARKET CLICKHOUSE TABLE CREATION")
    logger.info("=" * 70)
    ...
    try:
        ...
        logger.exception("CLICKHOUSE: failed to create Investing Stock Market table")
        raise

    logger.info("=" * 70)
    logger.info("INVESTING STOCK MARKET CLICKHOUSE TABLE CREATION FINISHED")
    logger.info("=" * 70)
