...
def main() -> None:
    logger.info("=" * 70)
    logger.info("INVESTING WORLD NEWS CLICKHOUSE TABLE CREATION")
    logger.info("=" * 70)
    ...
    try:
        ...
        logger.exception("CLICKHOUSE: failed to create Investing World News table")
        raise

    logger.info("=" * 70)
    logger.info("INVESTING WORLD NEWS CLICKHOUSE TABLE CREATION FINISHED")
    logger.info("=" * 70)
