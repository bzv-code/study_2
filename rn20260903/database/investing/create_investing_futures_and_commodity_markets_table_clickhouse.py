...
def main() -> None:
    logger.info("=" * 70)
    logger.info("INVESTING FUTURES AND COMMODITY MARKETS CLICKHOUSE TABLE CREATION")
    logger.info("=" * 70)
    ...
    try:
        ...
        logger.exception("CLICKHOUSE: failed to create Investing Futures and Commodity Markets table")
        raise

    logger.info("=" * 70)
    logger.info("INVESTING FUTURES AND COMMODITY MARKETS CLICKHOUSE TABLE CREATION FINISHED")
    logger.info("=" * 70)
