...
def main() -> None:
    logger.info("=" * 70)
    logger.info("INVESTING MARKET ANALYSTS CLICKHOUSE TABLE CREATION")
    logger.info("=" * 70)
    ...
    try:
        ...
        logger.exception("CLICKHOUSE: failed to create Investing Market Analysts table")
        raise

    logger.info("=" * 70)
    logger.info("INVESTING MARKET ANALYSTS CLICKHOUSE TABLE CREATION FINISHED")
    logger.info("=" * 70)
