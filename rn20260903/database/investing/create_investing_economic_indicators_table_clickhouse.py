...
def main() -> None:
    logger.info("=" * 70)
    logger.info("INVESTING ECONOMIC INDICATORS CLICKHOUSE TABLE CREATION")
    logger.info("=" * 70)
    ...
    try:
        ...
        logger.exception("CLICKHOUSE: failed to create Investing Economic Indicators table")
        raise

    logger.info("=" * 70)
    logger.info("INVESTING ECONOMIC INDICATORS CLICKHOUSE TABLE CREATION FINISHED")
    logger.info("=" * 70)
