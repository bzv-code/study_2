...
def main() -> None:
    logger.info("=" * 70)
    logger.info("INVESTING COMMODITIES CLICKHOUSE TABLE CREATION")
    logger.info("=" * 70)
    ...
    try:
        ...
        logger.exception("CLICKHOUSE: failed to create Investing Commodities table")
        raise

    logger.info("=" * 70)
    logger.info("INVESTING COMMODITIES CLICKHOUSE TABLE CREATION FINISHED")
    logger.info("=" * 70)
