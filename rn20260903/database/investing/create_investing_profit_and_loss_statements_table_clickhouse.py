...
def main() -> None:
    logger.info("=" * 70)
    logger.info("INVESTING PROFIT AND LOSS STATEMENTS CLICKHOUSE TABLE CREATION")
    logger.info("=" * 70)
    ...
    try:
        ...
        logger.exception("CLICKHOUSE: failed to create Investing Profit and Loss Statements table")
        raise

    logger.info("=" * 70)
    logger.info("INVESTING PROFIT AND LOSS STATEMENTS CLICKHOUSE TABLE CREATION FINISHED")
    logger.info("=" * 70)
