...
def main() -> None:
    logger.info("=" * 70)
    logger.info("INVESTING FORMS SEC CLICKHOUSE TABLE CREATION")
    logger.info("=" * 70)
    ...
    try:
        ...
        logger.exception("CLICKHOUSE: failed to create Investing Forms SEC table")
        raise

    logger.info("=" * 70)
    logger.info("INVESTING FORMS SEC CLICKHOUSE TABLE CREATION FINISHED")
    logger.info("=" * 70)
